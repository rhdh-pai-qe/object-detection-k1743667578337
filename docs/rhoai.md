...
3) Access the `workbench` named `object-detection-k1743667578337-notebook`.
...
5) In the terminal, run `cd object-detection-k1743667578337` to navigate to your sample app's directory.
